          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="relative overflow-hidden py-10 px-6 bg-indigo-700 sm:px-10 xl:p-12">
              ...
              <p className="mt-6 text-base text-indigo-50 max-w-3xl">
                Feel free to reach out at any time! I'm happy to connect with colleagues for collaboration or just to catch up! 
              </p>
              <p className="mt-6 text-base text-indigo-50 max-w-3xl">
                I'm also available for freelance work, so be sure to contact me if you're looking for a web developer to work on a project for you!
              </p>
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">+1 (662) 736-2944</span>
                </dd>
                <dt>
                ...
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">jprkr21@gmail.com</span>
                </dd>
              </dl>
